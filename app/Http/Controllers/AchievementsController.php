...
//        event(new LessonWatched($lesson,$user));
        $next_badge_achievement = $user->badges->next_badge_achievement - $user->achievements->count() > 0
        ...
        return response()->json([
            ...
            'next_available_achievements' => ['comment_achievement' => $user->next_comment_achievement->achievement ,'lesson_achievement'=>$user->next_lesson_achievement->achievement],
